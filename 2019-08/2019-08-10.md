...
[https://www.postgresql.org/docs/current/pgbench.html][0]  
...
或者将client_id作为动态identify的suffix组成，实现不同线程操作不同表的需求。（pgbench暂时还不支持这个功能, 可以参考这里说明 [《PostgreSQL 使用 pgbench 测试 sysbench 相关case - pg_oltp_bench》][1]   需要修改pgbench代码parseQuery）  
...
[《PostgreSQL 使用 pgbench 测试 sysbench 相关case - pg_oltp_bench》][1]  


[《PostgreSQL 10.0 preview 性能增强 - 2PC事务恢复阶段性能提升》][3]  


[《PostgreSQL native partition 分区表性能优化之 - 动态SQL+服务端绑定变量》][4]  


[《PostgreSQL Oracle 兼容性之 - DBMS_SQL(存储过程动态SQL中使用绑定变量-DB端prepare statement)》][5]  
...
[1]: https://github.com/digoal/blog/blob/master/201610/20161031_02.md
[2]: https://github.com/digoal/blog/blob/master/201610/20161031_02.md
[3]: https://github.com/digoal/blog/blob/master/201703/20170312_09.md
[4]: https://github.com/digoal/blog/blob/master/201901/20190109_01.md
[5]: https://github.com/digoal/blog/blob/master/201803/20180323_02.md
[6]: https://www.postgresql.org/docs/current/pgbench.html