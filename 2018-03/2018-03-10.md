...
[《PostgreSQL dblink异步调用实现 并行hash分片JOIN - 含数据交、并、差 提速案例》][6]  
...
[https://www.postgresql.org/docs/devel/static/pgtrgm.html][7]  
...
他们分别作用于以下操作符和函数(详见  [https://www.postgresql.org/docs/devel/static/pgtrgm.html][7]  )。  
...
[《PostgreSQL 全文检索之 - 位置匹配 过滤语法(例如 ‘速度 <1> 激情’)》][14]  


[《PostgreSQL 模糊查询 与 正则匹配 性能差异与SQL优化建议》][15]  


[《PostgreSQL 遗传学应用 - 矩阵相似距离计算 (欧式距离,…XX距离)》][16]  


[《多流实时聚合 - 记录级实时快照 - JSON聚合与json全文检索的功能应用》][17]  


[《PostgreSQL - 全文检索内置及自定义ranking算法介绍 与案例》][18]  


[《用PostgreSQL 做实时高效 搜索引擎 - 全文检索、模糊查询、正则查询、相似查询、ADHOC查询》][19]  


[《HTAP数据库 PostgreSQL 场景与性能测试之 17 - (OLTP) 数组相似查询》][20]  


[《HTAP数据库 PostgreSQL 场景与性能测试之 16 - (OLTP) 文本特征向量 - 相似特征(海明…)查询》][21]  


[《HTAP数据库 PostgreSQL 场景与性能测试之 14 - (OLTP) 字符串搜索 - 全文检索》][22]  


[《HTAP数据库 PostgreSQL 场景与性能测试之 13 - (OLTP) 字符串搜索 - 相似查询》][23]  


[《HTAP数据库 PostgreSQL 场景与性能测试之 12 - (OLTP) 字符串搜索 - 前后模糊查询》][24]  


[《HTAP数据库 PostgreSQL 场景与性能测试之 9 - (OLTP) 字符串模糊查询 - 含索引实时写入》][25]  


[《HTAP数据库 PostgreSQL 场景与性能测试之 7 - (OLTP) 全文检索 - 含索引实时写入》][26]  


[《多国语言字符串的加密、全文检索、模糊查询的支持》][27]  


[《Greenplum 模糊查询 实践》][28]  


[《全文检索 不包含 优化 - 阿里云RDS PostgreSQL最佳实践》][29]  


[《17种文本相似算法与GIN索引 - pg_similarity》][30]  


[《PostgreSQL 模糊查询最佳实践 - (含单字、双字、多字模糊查询方法)》][31]  


[《PostgreSQL 10.0 preview 功能增强 - JSON 内容全文检索》][32]  


[《PostgreSQL结合余弦、线性相关算法 在文本、图片、数组相似 等领域的应用 - 3 rum, smlar应用场景分析》][33]  


[《PostgreSQL结合余弦、线性相关算法 在文本、图片、数组相似 等领域的应用 - 2 smlar插件详解》][34]  


[《PostgreSQL结合余弦、线性相关算法 在文本、图片、数组相似 等领域的应用 - 1 文本(关键词)分析理论基础 - TF(Term Frequency 词频)/IDF(Inverse Document Frequency 逆向文本频率)》][35]  


[《导购系统 - 电商内容去重\内容筛选应用(实时识别转载\盗图\侵权?) - 文本、图片集、商品集、数组相似判定的优化和索引技术》][36]  


[《PostgreSQL 全表 全字段 模糊查询的毫秒级高效实现 - 搜索引擎颤抖了》][37]  


[《从难缠的模糊查询聊开 - PostgreSQL独门绝招之一 GIN , GiST , SP-GiST , RUM 索引原理与技术背景》][38]  


[《从相似度算法谈起 - Effective similarity search in PostgreSQL》][39]  


[《聊一聊双十一背后的技术 - 毫秒分词算啥, 试试正则和相似度》][40]  


[《PostgreSQL 全文检索加速 快到没有朋友 - RUM索引接口(潘多拉魔盒)》][41]  


[《PostgreSQL 文本数据分析实践之 - 相似度分析》][42]  


[《中文模糊查询性能优化 by PostgreSQL trgm》][43]  


[《PostgreSQL 行级 全文检索》][44]  


[《PostgreSQL 百亿数据 秒级响应 正则及模糊查询》][0]  


